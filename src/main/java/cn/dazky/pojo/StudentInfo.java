...
public class StudentInfo {
    ...
    public void setStudentName1(String studentName1) {
        this.studentName1 = studentName1 == null ? null : studentName1.trim();
    }
    ...
    public void setStudentHealth(String studentHealth) {
        this.studentHealth = studentHealth == null ? null : studentHealth.trim();
    }
    ...
    public void setStudentIndate(String studentIndate) {
        this.studentIndate = studentIndate == null ? null : studentIndate.trim();
    }
    ...
    public void setStudentMarital(String studentMarital) {
        this.studentMarital = studentMarital == null ? null : studentMarital.trim();
    }
    ...
    public void setStudentPost(String studentPost) {
        this.studentPost = studentPost == null ? null : studentPost.trim();
    }
    ...
    public void setFamilyTellphone(String familyTellphone) {
        this.familyTellphone = familyTellphone == null ? null : familyTellphone.trim();
    }
    ...
    public void setStudentIsleague(String studentIsleague) {
        this.studentIsleague = studentIsleague == null ? null : studentIsleague.trim();
    }
    ...
    public void setStudentJoinTime(String studentJoinTime) {
        this.studentJoinTime = studentJoinTime == null ? null : studentJoinTime.trim();
    }
    ...
    public void setStudentBeforeSchool(String studentBeforeSchool) {
        this.studentBeforeSchool = studentBeforeSchool == null ? null : studentBeforeSchool.trim();
    }
    ...
    public void setStudentHobby(String studentHobby) {
        this.studentHobby = studentHobby == null ? null : studentHobby.trim();
    }
    ...
    public void setStudentEduSys(String studentEduSys) {
        this.studentEduSys = studentEduSys == null ? null : studentEduSys.trim();
    }
    ...
    public void setStudentHard(String studentHard) {
        this.studentHard = studentHard == null ? null : studentHard.trim();
    }
    ...
    public void setStudentLoan(String studentLoan) {
        this.studentLoan = studentLoan == null ? null : studentLoan.trim();
    }
    ...
    public void setStudentMuster(String studentMuster) {
        this.studentMuster = studentMuster == null ? null : studentMuster.trim();
    }
